...
import com.saveetha.myjoints.databinding.ActivitySwollenJointsBinding;
...
public class SwollenJointsActivity extends AppCompatActivity {
    ...
    private ActivitySwollenJointsBinding binding;
    ...
    List<JointPoint> bodyJoints = Arrays.asList(
            ...
            new JointPoint(JointPosition.LEFT_WRIST, "Left Wrist", 0.185f, 0.43f),
            new JointPoint(JointPosition.RIGHT_WRIST, "Right Wrist", 0.73f, 0.43f),

            new JointPoint(JointPosition.LEFT_HAND_thumb_1, "Left hand THUMB finger 1", 0.256f, 0.53f),
            new JointPoint(JointPosition.LEFT_HAND_thumb_2, "Left hand  THUMB finger 2", 0.251f, 0.57f),
            new JointPoint(JointPosition.RIGHT_HAND_thumb_1, "RIGHT hand  THUMB finger 1", 0.70f, 0.53f),
            new JointPoint(JointPosition.RIGHT_HAND_thumb_2, "RIGHT hand THUMB FINGER 2", 0.71f, 0.57f),
            new JointPoint(JointPosition.LEFT_HAND_INDEX_1, "Left hand  INDEX finger 1", 0.18f, 0.547f),
            new JointPoint(JointPosition.LEFT_HAND_INDEX_2, "Left hand  INDEX finger 2", 0.152f, 0.585f),
            new JointPoint(JointPosition.LEFT_HAND_INDEX_3, "Left hand  INDEX finger 3", 0.14f, 0.61f),
            new JointPoint(JointPosition.LEFT_HAND_MIDDLE_1, "Left hand  MIDDLE finger 1", 0.131f, 0.532f),
            new JointPoint(JointPosition.LEFT_HAND_MIDDLE_2, "Left hand MIDDLE finger 2", 0.10f, 0.570f),
            new JointPoint(JointPosition.LEFT_HAND_MIDDLE_3, "Left hand  MIDDLE finger 3", 0.07f, 0.597f),
            ...
            new JointPoint(JointPosition.RIGHT_HAND_INDEX_2, "RIGHT hand INDEX FINGER 2", 0.808f, 0.587f),
            new JointPoint(JointPosition.RIGHT_HAND_INDEX_3, "RIGHT hand INDEX FINGER 3", 0.835f, 0.610f),
            ...
            new JointPoint(JointPosition.RIGHT_HAND_RING_2, "RIGHT hand MIDDLE FINGER 2", 0.888f, 0.543f),
            new JointPoint(JointPosition.RIGHT_HAND_RING_3, "RIGHT hand MIDDLE FINGER 3", 0.917f, 0.564f),
            ...
            new JointPoint(JointPosition.LEFT_LEG_INDEX_1, "Left LEG INDEX FINGER", 0.385f, 0.86f),
            new JointPoint(JointPosition.LEFT_LEG_THUMB_1, "Left LEG THUMB FINGER 1", 0.425f, 0.862f),
            new JointPoint(JointPosition.LEFT_LEG_THUMB_2, "Left LEG THUMB FINGER 1", 0.422f, 0.882f),
            new JointPoint(JointPosition.LEFT_LEG_MIDDLE_1, "Left LEG MIDDLE FINGER", 0.349f, 0.852f),
            new JointPoint(JointPosition.LEFT_LEG_RING_1, "Left LEG RING FINGER", 0.319f, 0.842f),
            new JointPoint(JointPosition.LEFT_LEG_LITTLE_1, "Left LEG LITTLE FINGER", 0.295f, 0.831f),

            new JointPoint(JointPosition.RIGHT_LEG_THUMB_1, "Right LEG THUMB FINGER1", 0.545f, 0.863f),
            new JointPoint(JointPosition.RIGHT_LEG_THUMB_2, "Right LEG THUMB FINGER2", 0.547f, 0.883f),
            new JointPoint(JointPosition.RIGHT_LEG_INDEX_1, "Right LEG INDEX FINGER", 0.583f, 0.861f),
            new JointPoint(JointPosition.RIGHT_LEG_MIDDLE_1, "Right LEG MIDDLE FINGER", 0.615f, 0.855f),
            new JointPoint(JointPosition.RIGHT_LEG_RING_1, "Right LEG RING FINGER", 0.644f, 0.844f),
            new JointPoint(JointPosition.RIGHT_LEG_LITTLE_1, "Right LEG LITTLE FINGER ", 0.674f, 0.832f),
            ...
            new JointPoint(JointPosition.LEFT_ANKLE, "Left Ankle", 0.40f, 0.71f),
            new JointPoint(JointPosition.RIGHT_ANKLE , "Right Ankle", 0.54f, 0.71f)
    );
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivitySwollenJointsBinding.inflate(getLayoutInflater());
...
//            dot.setImageResource(R.drawable.ic_tick);
        ...
        binding.tvSelectedCount.setText("Selected: " + selected.size());
    }
